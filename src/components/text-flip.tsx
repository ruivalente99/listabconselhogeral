...
export default function TextFlip() {
  const words = useMemo(() => ["por ti", "pela academia", "por ti", "pela academia"], []);
  ...
  return (
    <div className="flex gap-4 text-3xl font-semibold">
      <p className="text-fuchsia-600">Norteados </p>
      <div ref={tallestRef} className="flex flex-col overflow-hidden text-purple-400">
